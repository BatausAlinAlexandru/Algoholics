...
export class ProductService {
  ...
  products = [
    ...
    { id: 7, name: 'REKAM PRESTO-SL101', description: 'Descriere produs', image: '/assets/img/product09.png', price: 436.00 },
